 ...
 * @author PC
 */
public final class ThemThiSinh extends javax.swing.JDialog {

    /**
     * Creates new form ThemThiSinh
     */
    private QLThiSinh dsts;
    private final Filee db2 = new Filee();
    ...
    public ThemThiSinh(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        ...
        try {
            dsPT = (ArrayList) db2.readDataFromFile(fileName);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText() == ""||jTextField2.getText()==""||jTextField3.getText()=="" ||
            ...
            if (isMSV == false) {
                ...
                JOptionPane.showMessageDialog(rootPane, "phong thi khong ton tai");
            }
            else {
